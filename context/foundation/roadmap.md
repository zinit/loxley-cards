...
- **Outcome:** (foundation) silnik gry gotowy — reguły partii (best-of-3, rzędy close/ranged/siege), scoring z modyfikatorami, bot deterministyczny (scoring-based), definicje kart, pełny zestaw abilities (pogoda, horn, spy, medic, muster, tight bond, leader abilities). Atomowy — wszystkie abilities wchodzą razem.
